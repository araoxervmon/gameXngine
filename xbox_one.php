...
<link rel="icon" href="images/favicon.png" type="image/png" sizes="16x16">
	...
	<body>
		<?php require "config.php";
		 include 'header.php'; 
		$sql=$dbo->prepare("SELECT `gameName`, `publisher` FROM `gamelist` left join console on gamelist.consoleId = console.consoleId where console.consoleId = 1 group by gameName ");
